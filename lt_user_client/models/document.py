...
class Document(object):
    ...
    def __init__(self, id=None, title=None, description=None, file=None, _date=None, display_html=None, created_at=None, published=None, category=None, document_type=None, publisher=None, related_documents=None, sites=None, _configuration=None):  # noqa: E501
    ...
    def display_html(self, display_html):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and display_html is None:
            raise ValueError("Invalid value for `display_html`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                display_html is not None and len(display_html) < 1):
            raise ValueError("Invalid value for `display_html`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def sites(self, sites):
        ...
        :type: list[int]
        """
        if self._configuration.client_side_validation and sites is None:
